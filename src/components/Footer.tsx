function Footer() {
  ...
  return (
    <footer
      className="bg-dark position-relative overflow-hidden pb-0 pt-6 pt-lg-8"
      data-bs-theme="dark"
    >
      <figure className="position-absolute top-0 start-0 mt-n8 ms-n9">
        <svg
          className="fill-mode"
          width="775px"
          height="834px"
        ...
        <div className="row g-4 justify-content-between">
          ...
          <div className="col-lg-8 col-xxl-7">
            <div className="row g-4">
              ...
              <div className="col-6 col-md-4">
                <h6 className="mb-2 mb-md-4">Information</h6>
                <ul className="nav flex-column">
                  {/* <li className="nav-item">
              ...
              <div className="col-md-4">
                <h6 className="mb-2 mb-md-4">Address</h6>
