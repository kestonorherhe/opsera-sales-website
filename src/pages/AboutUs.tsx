...
function AboutUs() {
  return (
    <>
      ...
      <main>
        <section className="pt-5 pt-xl-9">
          <div className="container">
            <div className="row">
              <div className="col-xl-10 text-center mx-auto">
                ...
                <p className="lead mb-0">We are an insight and behaviors driven creative marketing agency. A Full package Digital Creative Agency Specializing in: Video Production, Web Design, Branding, Brand Strategy, Content Marketing and Aerial Cinematography.</p>

                <div className="row g-4 mt-5 mx-auto align-items-end">
                  <div className="col-md-5 position-relative">
                    <img src="assets/images/about/14.jpg" className="rounded mb-4" alt="about-img" />
                    ...
                    <div className="text-end position-relative d-none d-md-block">
                      ...
                      <img src="assets/images/about/16.jpg" className="rounded mb-4 w-50" alt="about-img" />
                    </div>
                  </div>

                  <div className="col-md-7 position-relative mb-n4">
                    ...
                    <div className="card card-body bg-dark text-start z-index-2 w-75 p-5 mb-4">
                      ...
                      <h4 className="text-white fw-light mb-0 mt-3">"We believe that it takes great people to deliver a great product"</h4>
                    </div>

                    <div className="card card-body overflow-hidden p-0">
                      <img src="assets/images/about/15.jpg" className="card-img" alt="about-img" />
                      <div className="bg-overlay bg-dark opacity-2"></div>
                      <div className="position-absolute end-0 bottom-0 m-3 z-index-2">
                        <a href="https://www.youtube.com/embed/tXHviS-4ygo" className="btn btn-lh btn-white" data-glightbox data-gallery="course-video"><i className="bi bi-youtube text-danger fa-fw fa-xl me-1"></i> Watch our story</a>
                      </div>
                    </div>
                  </div>
                </div>
