            ...
            <div className="position-relative mt-5">
              ...
              <div className="bg-light border rounded-2 position-relative z-index-2 p-2 mb-2">
                <form className="input-group">
                  <input className="form-control form-control-lg focus-shadow-none bg-light border-0 me-1" type="email" placeholder="Enter your email address" />
                  <button type="button" className="btn btn-lg btn-dark rounded-2 mb-0">Subscribe now!</button>
                </form>
              </div>
            </div>
            <p className="small mb-0 px-4">Subscribe now and receive weekly newsletter with educational materials, new courses, interesting posts, popular books, and much more!</p>
          </div>
        </div>
      </section>
    </main>
