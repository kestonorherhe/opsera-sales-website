      ...
      <main>
        <section className="pt-lg-8">
          <div className="container pt-4 pt-lg-0">
            <div className="row g-4 g-xl-6 align-items-center">
              <div className="col-md-6">
                <h1 className="mb-4">Frequently Asked Questions</h1>
                <p className="mb-0">Need a help with something? Here are our most frequently asked questions.</p>

                <div className="col-10 mt-4">
                  <form className="position-relative">
                    <input className="form-control form-control-lg bg-light ps-6" type="search" placeholder="Enter your keyword..." aria-label="Search" />
                    <button className="btn bg-transparent px-3 py-0 position-absolute top-50 start-0 translate-middle-y" type="submit"><i className="bi bi-search fs-6"> </i></button>
                  </form>
                </div>
              </div>
              ...
              <div className="col-md-6">
                <svg viewBox="0 0 502.3 300.7">
                  ...
                  <path className="fill-mode opacity-9" d="M384.7,204.5l115.2-0.1l-59.7,91.5L325,295.9L384.7,204.5z M496.1,206.4l-110.3,0.1l-57,87.4l110.3-0.1 L496.1,206.4z" />
                  <path className="fill-mode opacity-9" d="M290.4,299.1l153.5-0.1v-8.1l-148.2,0.1c-3,0-5.3,2.4-5.3,5.3V299.1z" />
                  <path className="fill-mode opacity-9" d="M419.9,250.7c-1.6,2.6-1.8,5.6-0.1,6.5c1.5,0.9,4.2-0.3,5.8-2.8c1.6-2.6,1.8-5.6,0.1-6.5 C424.1,246.8,421.5,248,419.9,250.7z" />
                </svg>
              </div>
            ...
            <div className="bg-primary bg-opacity-10 rounded p-4 p-sm-5">
              ...
              <div className="row">
                <div className="col-lg-7 text-center mx-auto">
                  ...
                  <a href="contact-v1.html" className="btn btn-lg btn-dark mb-0">Contact us</a>
                </div>
              </div>
            </div>
          </div>
